...
public:
    ...
    bool onInitialize() override
    {
        ...
        gRun = (dwSensor_start(gRadarSensor) == DW_SUCCESS);
    ...
    {
	    {
	        ...
	        if (gRunDynamics)
	            radarDynamics_stop();
	        dwSensor_stop(gRadarSensor);
	        dwSAL_releaseSensor(&gRadarSensor);
...
protected:
    ...
    void initializeRenderer()
    {
        ...
        uint32_t maximumPoints = gRadarProperties.maxReturnsPerScan;
    ...
    void initializeSensor(ProgramArguments &arguments)
    {
        ...
        gRadarSensor = DW_NULL_HANDLE;
        {
            ...
            if( dwSAL_createSensor(&gRadarSensor, params, sal) == DW_SUCCESS)
            {
