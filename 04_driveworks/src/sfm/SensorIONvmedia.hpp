...
{
  public:
    SensorIONvmedia(dwContextHandle_t context, cudaStream_t stream, uint32_t sensorCount, dwSensorHandle_t cameraSensor[], int cameraWidth, int cameraHeight);
    ~SensorIONvmedia();
  ...
  protected:
    ...
    std::vector<dwImageStreamerHandle_t> m_nvm2gl;
    std::vector<dwImageStreamerHandle_t> m_nvm2cuda;
    ...
    std::vector<dwImageNvMedia *> m_frameNvmYuv;
